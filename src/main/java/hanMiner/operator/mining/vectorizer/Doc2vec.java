package hanMiner.operator.mining.vectorizer;
...
public class Doc2vec extends Operator{
    ...
    public Doc2vec(OperatorDescription description) {
        ...
        textInput.addPrecondition(
                new SimplePrecondition(textInput, new MetaData(TextSet.class)) {
    ...
    public void doWork() throws OperatorException {
        String doc = textInput.getData(SimpleTextSet.class).toString();
