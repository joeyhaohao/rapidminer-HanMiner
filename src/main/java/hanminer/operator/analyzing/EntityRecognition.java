...
public class EntityRecognition extends Operator {
    ...
    public String getEntities(List<Term> terms, String entityTag) {
        List<String> entities = new ArrayList<>();
        for (Term term: terms) {
            if (term.nature.toString().contains(entityTag)) {
